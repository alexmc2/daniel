...
const HERO_HEIGHTS: { title: string; value: "60vh" | "80vh" | "100vh" | "custom" }[] = [
...
const SPACING_SCALE: {
  title: string;
  value: "compact" | "cozy" | "roomy" | "spacious";
}[] = [
...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      validation: (rule) => rule.min(30).max(160),
    }),
    defineField({
      name: "contentSpacing",
      title: "Content Gap",
    ...
    defineField({
      ...
      group: "layout",
      description:
        "Adjust outer padding for the entire hero so it breathes against page edges.",
    }),
    defineField({
      name: "textAlign",
      ...
      group: "content",
      description:
        "Set how copy and CTAs align within the hero content column.",
    }),
    defineField({
      name: "invertText",
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          description:
            "Choose whether the hero media area renders an image or a Lottie animation.",
        }),
        defineField({
          name: "image",
          title: "Image",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          hidden: ({ parent }) => !parent?.enabled,
          description:
            "Control the breathing room inside the shape surrounding hero content.",
        }),
        defineField({
          name: "shadow",
          title: "Shadow",
