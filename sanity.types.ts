...
export type HeroFlex = {
  ...
  minHeight?: "60vh" | "80vh" | "100vh" | "custom";
  minHeightCustom?: number;
  contentSpacing?: "compact" | "cozy" | "roomy" | "spacious";
  paddingStrategy?: "compact" | "cozy" | "roomy" | "spacious";
...
export type AllSanitySchemaTypes = ReviewsCarousel | LottieAnimation | MenuGoogleSection | MenuSection | AllPosts | LocationMap | FormContactMap | FormContact | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | ImageGallery | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitLocationMap | SplitContactForm | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | RichTextBlock | SectionHeader | HeroFull | Hero2 | Hero1 | HeroFlex | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Settings | Navigation | Testimonial | Faq | Category | Page | LottieAsset | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    minHeight: "100vh" | "60vh" | "80vh" | "custom" | null;
    minHeightCustom: number | null;
    contentSpacing: "compact" | "cozy" | "roomy" | "spacious" | null;
    paddingStrategy: "compact" | "cozy" | "roomy" | "spacious" | null;
